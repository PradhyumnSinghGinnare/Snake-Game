...
import 'constrained_scaffold.dart';
...
class _SnakeGamePageState extends State<SnakeGamePage> {
  ...
  void startGame() {
    ...
    // set up a periodic time to update the snake's position
  ...
  void generateFood() {
    // fenerate a random position of the food
